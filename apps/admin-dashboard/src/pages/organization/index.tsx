    ...
    <div className="p-4 md:p-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <Card className="p-6 lg:col-span-3">
            <h2 className="text-xl font-bold text-foreground mb-4">Thông Tin Công Ty</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label className="text-sm text-muted-foreground">Tên Công Ty</label>
                <p className="text-lg font-medium text-foreground">TechCorp Inc.</p>
              </div>
              <div>
                <label className="text-sm text-muted-foreground">Trụ Sở Chính</label>
              ...
              <div>
                <label className="text-sm text-muted-foreground">Tổng Nhân Viên</label>
          ...
          <Card className="p-6 lg:col-span-2">
            ...
            <div className="space-y-3">
              {["Kỹ Thuật", "Bán Hàng", "Tiếp Thị", "Nhân Sự", "Tài Chính", "Vận Hành"].map(
                (dept) => (
                  <div
                    key={dept}
          ...
          {/* Org Chart Preview */}
          <Card className="p-6">
            <h2 className="text-xl font-bold text-foreground mb-4">Sơ Đồ Tổ Chức</h2>
            <p className="text-sm text-muted-foreground mb-4">
              Cấu trúc cây trực quan của phân cấp tổ chức của bạn với khả năng mở rộng/thu gọn.
            </p>
