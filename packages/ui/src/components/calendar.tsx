  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        // --- PHẦN QUAN TRỌNG ĐỂ CANH ĐỀU ---
        table: "w-full border-collapse space-y-1",
        head_row: "flex w-full justify-between", // Đảm bảo hàng tiêu đề trải đều
        head_cell: "text-muted-foreground rounded-md w-9 font-normal text-[0.8rem] flex-1 text-center", 
        row: "flex w-full mt-2 justify-between", // Đảm bảo các hàng ngày trải đều
